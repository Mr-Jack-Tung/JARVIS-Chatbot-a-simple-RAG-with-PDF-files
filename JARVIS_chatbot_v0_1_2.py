...
def btn_key_save_click(txt_groq_api_key, txt_openai_api_key):
        ...
        with gr.Column(scale=2):
            with gr.Tab("Model"):
                with gr.Row():
                    with gr.Row(variant="panel"):
                        ...
                        dropdown_model_type = gr.Dropdown(choices=["Ollama", "GroqCloud", "OpenAI", "LiteLLM"], value=model_settings.MODEL_TYPE, type="value", label="Type", interactive=True, min_width=220)
            ...
            with gr.Tab("API Key"):
                with gr.Row(variant="panel"):
                    ...
                    btn_key_save.click(fn=btn_key_save_click, inputs=[txt_groq_api_key, txt_openai_api_key])
